...
<head>
    ...
    <title>Control Panel - Mycms NobiSoft</title>
    <!-- Custom CSS -->
                        ...
                        if(!isset($saction)){
                            ...
                            if(isset($_GET['id'])){
                                ...
                                if(($saction=="Add" || $saction=="PutOnline" || $saction=="PutOffline" || $saction=="Update" || $saction=="Del" )){
                                    ...
                                    $file_to_include.="_s_".$saction.".php";
                                }
...
<?php require("core/include/modal.php") ?>
</body>
